...
class Controller(BaseController):
  ...
  """
  def __init__(self, 
      params=[0.7263320407194084, 0.09334246792964405, -0.22523276332931466, -0.12912607082715807, 
      0.24389708557689815, 1.2081190902979582, 0.5246729424761676, 0.5101860160129517]
      ):
    self.p = params[0]
    self.i = params[1]
    self.d = params[2]
